...
class TestScalarPeriodCounter(unittest.TestCase):
    def setUp(self) -> None:
        ...
        # Setup counter
        self.counter = ScalarPeriodCounter(max_period_length, min_amplitude, max_amplitude, min_std)
    ...
    def test_sine(self):
        ...
        times, values = self.helper_generate_sine(amplitude=300, period=5.0, end_time=60.0, sample_time=0.05)
